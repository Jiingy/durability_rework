...
public enum ItemLevelBarMode implements TranslatableOption {
	ALWAYS(0, "options.durability_rework.itemLevelBar.always"),
	HOVER(1, "options.durability_rework.itemLevelBar.hover"),
	NEVER(2, "options.durability_rework.itemLevelBar.never")
	;
