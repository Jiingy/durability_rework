...
public class EquipmentFamilies {
	...
	public static final EquipmentFamily WOODEN = register(Items.OAK_PLANKS)
			.smithingTemplate(DrItems.STONE_UPGRADE_SMITHING_TEMPLATE)
			.pickaxe(Items.WOODEN_PICKAXE)
			.axe(Items.WOODEN_AXE)
			.sword(Items.WOODEN_SWORD)
			.shovel(Items.WOODEN_SHOVEL)
			.hoe(Items.WOODEN_HOE)
			.helmet(DrItems.WOODEN_HELMET)
			.chestplate(DrItems.WOODEN_CHESTPLATE)
			.leggings(DrItems.WOODEN_LEGGINGS)
			.boots(DrItems.WOODEN_BOOTS)
	...
	public static final EquipmentFamily STONE = register(Items.STONE)
			.smithingTemplate(DrItems.COPPER_UPGRADE_SMITHING_TEMPLATE)
	...
	public static final EquipmentFamily COPPER = register(Items.COPPER_INGOT)
			.smithingTemplate(DrItems.IRON_UPGRADE_SMITHING_TEMPLATE)
	...
	public static final EquipmentFamily IRON = register(Items.IRON_INGOT)
			.smithingTemplate(DrItems.GOLD_UPGRADE_SMITHING_TEMPLATE)
	...
	public static final EquipmentFamily GOLDEN = register(Items.GOLD_INGOT)
			.smithingTemplate(DrItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE)
