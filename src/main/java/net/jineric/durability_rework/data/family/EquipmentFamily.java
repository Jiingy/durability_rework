package net.jineric.durability_rework.data.family;
...
public class EquipmentFamily {
	private final Map<Variant, Item> variants = Maps.newHashMap();
	private final Map<Item, Boolean> generateRecipe = Maps.newHashMap();
	...
	public static class Builder {
		...
		public final EquipmentFamily.Builder smithingTemplate(Item smithingTemplate) {
			this.equipmentFamily.smithingTemplate = smithingTemplate;
			return this;
		}
		
		public final EquipmentFamily.Builder upgradeMaterial(Item upgradeMaterial) {
			this.equipmentFamily.upgradeMaterial = upgradeMaterial;
			return this;
		}
		
		public final EquipmentFamily.Builder materialTag(TagKey<Item> materials) {
			this.equipmentFamily.materialTag = materials;
			return this;
		}
		
		public final EquipmentFamily.Builder genRecipes(boolean canGenerate) {
			this.equipmentFamily.genRecipes = canGenerate;
			return this;
		}
		
		public final EquipmentFamily.Builder skipToolRecipes() {
			this.equipmentFamily.skipToolRecipes = true;
			return this;
		}
		
		public final EquipmentFamily.Builder pickaxe(Item pickaxe) {
			this.equipmentFamily.variants.put(EquipmentVariants.PICKAXE, pickaxe);
			return this;
		}
		
		public final EquipmentFamily.Builder axe(Item axe) {
			this.equipmentFamily.variants.put(EquipmentVariants.AXE, axe);
			return this;
		}
		
		public final EquipmentFamily.Builder sword(Item sword) {
			this.equipmentFamily.variants.put(EquipmentVariants.SWORD, sword);
			return this;
		}
		
		public final EquipmentFamily.Builder shovel(Item shovel) {
			this.equipmentFamily.variants.put(EquipmentVariants.SHOVEL, shovel);
			return this;
		}
		
		public final EquipmentFamily.Builder hoe(Item hoe) {
			this.equipmentFamily.variants.put(EquipmentVariants.HOE, hoe);
			return this;
		}
		
		public final EquipmentFamily.Builder helmet(Item helmet) {
			this.equipmentFamily.variants.put(EquipmentVariants.HELMET, helmet);
			return this;
		}
		
		public final EquipmentFamily.Builder chestplate(Item chestplate) {
			this.equipmentFamily.variants.put(EquipmentVariants.CHESTPLATE, chestplate);
			return this;
		}
		
		public final EquipmentFamily.Builder leggings(Item leggings) {
			this.equipmentFamily.variants.put(EquipmentVariants.LEGGINGS, leggings);
			return this;
		}
		
		public final EquipmentFamily.Builder boots(Item boots) {
	...
	public static class Variant {
		...
		public static EquipmentSlot equipmentSlot(Variant variant) {
